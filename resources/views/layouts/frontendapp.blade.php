    ...
    <header class="header-section header-normal">
        <div class="container-fluid">
            ...
            <div class="header-right">
                <a href="{{url('cart')}}" class="card-bag"><img src="{{asset('frontend_assets/img/icons/bag.png')}}" alt=""><span>{{App\Cart::where('customer_ip',$_SERVER['REMOTE_ADDR'])->count()}}</span></a> {{--or sum('product_quantity') --}}
